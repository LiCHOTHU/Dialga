#!/bin/bash
#SBATCH --job-name=dlg_5_eventhead
...
#SBATCH --output=/storage/project/r-agarg35-0/lwang831/outputs/dialga/slurm/dlg_5_eventhead_%j.out
#SBATCH --error=/storage/project/r-agarg35-0/lwang831/outputs/dialga/slurm/dlg_5_eventhead_%j.err

# 5-video overfit Stage 1 with EventHead supervision enabled (v3 design).
# Stage 2 disabled — we only need encoder + event_head for Phase-3 inference test.
...
RUN_NAME=${RUN_NAME:-slot_5_eventhead_$(date +%m%d_%H%M)}
...
echo "=========================================="
echo " 5-video overfit Stage 1 + EventHead"
echo "=========================================="
